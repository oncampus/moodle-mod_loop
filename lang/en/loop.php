...
$string['settings:default_theme_desc'] = 'Default theme for LOOPs';
$string['settings:loop_token'] = 'Loop token';
$string['settings:loop_token_desc'] = 'This is the token to get the allowed LOOPs and get the structe for a LOOP';
